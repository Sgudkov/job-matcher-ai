...
async def vectorize_candidate(candidate: CandidateBase):
    embedding_soft = members_embedding_system.vectorize_candidate_data(candidate,
                                                                       MembersDataType.SOFT_SKILL)
    embedding_hard = members_embedding_system.vectorize_candidate_data(candidate,
...
async def vectorize_employer(employer: EmployerBase):
    embedding_soft = members_embedding_system.vectorize_employer_data(employer,
                                                                      MembersDataType.SOFT_SKILL)
    embedding_hard = members_embedding_system.vectorize_employer_data(employer,
                                                                      MembersDataType.HARD_SKILL)
